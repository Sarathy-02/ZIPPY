...
import static sara.converter.util.Constants.DEFAULT_BORDER_WIDTH;
import static sara.converter.util.Constants.DEFAULT_COMPRESSION;
import static sara.converter.util.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static sara.converter.util.Constants.DEFAULT_IMAGE_SCALE_TYPE_TEXT;
import static sara.converter.util.Constants.DEFAULT_PAGE_COLOR;
import static sara.converter.util.Constants.DEFAULT_PAGE_SIZE;
import static sara.converter.util.Constants.DEFAULT_PAGE_SIZE_TEXT;
import static sara.converter.util.Constants.DEFAULT_QUALITY_VALUE;
import static sara.converter.util.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
import static sara.converter.util.Constants.MASTER_PWD_STRING;
import static sara.converter.util.Constants.OPEN_SELECT_IMAGES;
...
import static sara.converter.util.WatermarkUtils.getStyleNameFromFont;
import static sara.converter.util.WatermarkUtils.getStyleValueFromName;
...
import sara.converter.activity.ImageEditor;
import sara.converter.activity.PreviewActivity;
import sara.converter.activity.RearrangeImages;
...
import sara.converter.util.SharedPreferencesUtil;
